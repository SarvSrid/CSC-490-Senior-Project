...
import {ChevronDown, Cpu, Home, LogOut, Menu, Moon, Settings, Sun, User,} from "lucide-react";
...
export default function DashboardClient({userData, initialProgress}: DashboardClientProps){
